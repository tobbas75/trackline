...
* L3 (10µH) and L4 (27nH) — what do these filter?
    THEY ARE A DATASHEET RECOMMANDATIONS 
        L3 IS FOR MINIMISING THE CURRENT RIPLES
        L4 is an RF Bias-T inductor
* R47/C33 — RC filter on GPIO0?
    I can't see GPIO with it but they are for R47(Antenna supervisor current limite) C33(RF Bias-T capacitor)
* C36/C37 — what are these decoupling?
    they are for minimizing riples (they shoould be 22µF as datasheet table recommandes)
...
Could you please explain the C115330 request.
